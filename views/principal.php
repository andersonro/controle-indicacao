...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8 col-md-6	col-lg-8">
			<?php
			$img = '';
			if($qtd_indicados_confirmados < $_SESSION['usuario']['links'][2]['qtd']){
				//IMAGEM DA QTD DO LINK 1
				$img = 'thanos2-1280x566.jpg';
			}else if($qtd_indicados_confirmados>=$_SESSION['usuario']['links'][2]['qtd'] && $qtd_indicados_confirmados<$_SESSION['usuario']['links'][3]['qtd']){
				//IMAGEM DA QTD DO LINK 1
				$img = 'img3.png';
			}else{
				//IMAGEM DA QTD DO LINK 1
	...
	<div class="row">
		...
		$link_compra = '';
		if($qtd_indicados_confirmados < $_SESSION['usuario']['links'][2]['qtd']){
			gerarAlerta('Você ainda não possui indicações cadastras e confirmadas, mas se desejar adquirir o seu prêmio
								   acesse o link: <a href="'.$_SESSION['usuario']['links'][1]['link'].'" target="_blank">Adquira aqui seu Prẽmio</a>', 'warning', TRUE, TRUE, FALSE);
		}else if($qtd_indicados_confirmados>=$_SESSION['usuario']['links'][2]['qtd'] && $qtd_indicados_confirmados<$_SESSION['usuario']['links'][3]['qtd']){
			gerarAlerta('Com a quantidade de '.$qtd_indicados_confirmados.', você consegui adquirir o seu prêmio com 50% de
								   desconto, acesse o link: <a href="'.$_SESSION['usuario']['links'][2]['link'].'" target="_blank">Adquira aqui seu Prẽmio</a>', 'warning', TRUE, TRUE, FALSE);
		}else{
			gerarAlerta('Parabêns você conseguiu a quantidade de indicados, acesse o link: <a href="'.$_SESSION['usuario']['links'][3]['link'].'" target="_blank">Adquira aqui seu Prẽmio</a>, e recebe seu prêmio', 'success', TRUE, TRUE, FALSE);
		}
		?>
		</div>
		<div class="col-xs-0 col-sm-2 col-md-3	col-lg-2"></div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<!-- LINK DO VIDEO DE EXPLICAÇÃO DA RECOMPENSA  -->
